// Project F: Hardware Sprites - superfrog Verilator C++
...
int main(int argc, char* argv[]) {
    ...
    sdl_window = SDL_CreateWindow("Superfrog Sprite", SDL_WINDOWPOS_CENTERED,
    ...
    Vtop_superfrog* top = new Vtop_superfrog;
